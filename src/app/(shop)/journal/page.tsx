  ...
  return (
    <div className="min-h-screen" style={{ background: 'radial-gradient(120% 90% at 15% 0%, #faf5ec 0%, #F9F4EE 55%)' }}>
      ...
      <header className="max-w-[760px] mx-auto text-center px-5 pt-16 md:pt-24 pb-8">
        <p className="text-[13px] tracking-[0.28em] uppercase text-[#7d5411] mb-3.5">Journal</p>
      ...
      <div className="max-w-[1240px] mx-auto px-5 pb-20">
        {isApproved && (
          <div className="flex justify-end mb-8">
            <Link href="/blog/write?category=journal" className="text-xs font-semibold px-4 py-2 rounded-full bg-[#7d5411] text-white hover:bg-[#5a3b0a] transition-colors no-underline">
              + 글쓰기
            </Link>
          </div>
        )}
