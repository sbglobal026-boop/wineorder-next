...
export default function AboutPage() {
  return (
    <InfoPageLayout
      eyebrow="About"
      title="Table Code"
      subtitle="Good food. Good people. Good stories. 테이블은 문화가 시작되는 곳입니다."
    >
      <h2 className="text-lg font-bold text-[#1C1A17] mt-4 mb-2">우리의 이야기</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-bold text-[#1C1A17] mt-8 mb-2">우리가 지향하는 것</h2>
      <p className="mb-4">
      ...
      <h2 className="text-lg font-bold text-[#1C1A17] mt-8 mb-2">우리의 약속</h2>
      <p className="mb-4">
