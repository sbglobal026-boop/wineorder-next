    ...
    <div className="bg-[#FFFFFF] min-h-screen flex items-center justify-center px-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          <p className="text-[#0e3719] text-xs font-bold tracking-widest uppercase mb-2">Wine Order</p>
        ...
        <p className="text-center text-xs text-gray-400 mt-6">
          계정이 없으신가요?{' '}
          <Link href="/register" className="text-gray-700 font-semibold hover:underline">회원가입</Link>
        </p>
      </div>
    </div>
  )
