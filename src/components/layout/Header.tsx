...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-50">
      {/* 공지 배너 */}
      <div className="bg-[#1C1A17] text-[#FBFAF7] flex items-center justify-between px-[20px] py-[9px] text-[12.5px] tracking-wide">
      ...
      <div className="bg-[#FBFAF7] border-b border-[#1C1A17]/10">
        <div className="px-[20px] h-14 flex items-center justify-between">
        ...
        {mobileOpen && (
          <nav className="md:hidden border-t border-[#1C1A17]/10 px-[20px] py-4 flex flex-col gap-4 bg-[#FBFAF7]">
            {navItems.map((item) => (
