      ...
      <div className="p-5">
        ...
        <div className="flex items-center justify-between">
          ...
          <button
            ...
            disabled={isSoldOut}
            className={`p-2 transition-colors duration-200 ${isSoldOut ? 'bg-gray-200 text-gray-400 cursor-not-allowed' : 'bg-[#0e3719] group-hover:bg-[#2C5F2D] text-white cursor-pointer'}`}
